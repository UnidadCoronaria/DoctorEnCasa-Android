...
public class ClinicHistoryFragment extends BaseFragment<ClinicHistoryPresenter> implements ClinicHistoryView {
    ...
    public void onClinicHistoryListRetrieved(List<ClinicHistory> clinicHistoryList) {
        mClinicHistoryAdapter = new ClinicHistoryAdapter(clinicHistoryList);
