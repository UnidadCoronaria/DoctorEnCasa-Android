...
public class CreateCallUseCase extends SingleItemUseCase {

    private final VideoCallRepository mVideoCallRepository;

    @Inject
    public CreateCallUseCase(VideoCallRepository mVideoCallRepository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    public Single<VideoCall> buildUseCaseObservable() {
        return this.mVideoCallRepository.create();
    }
