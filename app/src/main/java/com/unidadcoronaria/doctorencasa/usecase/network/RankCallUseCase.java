...
public class RankCallUseCase extends SingleItemUseCase {
    ...
    @Inject
    public RankCallUseCase(VideoCallRepository mVideoCallRepository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    public Single<VideoCall> buildUseCaseObservable() {
        return this.mVideoCallRepository.rank(this.videoCallDTO);
    }
